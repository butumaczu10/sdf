...
# ----------------- 16유형 데이터 -----------------
TYPES = {
    "2458":{"name":"위기 전략가","strengths":"계획적이고, 현실적이다. 위기에서도 침착하다.","weaknesses":"융통성 부족으로 돌발 변수에 약할 수 있다.","advice":"세운 계획을 기본으로 하되 예외 시나리오를 준비하세요."},
    "2468":{"name":"공동체 수호자","strengths":"타인을 잘 돌보고 신뢰감을 준다.","weaknesses":"자기 안전을 뒤로 미루는 경향이 있다.","advice":"도움과 자기보호의 균형을 지키세요."},
    "2368":{"name":"장기전 분석가","strengths":"상황을 넓게 읽고 장기 전략에 강하다.","weaknesses":"과도한 고민으로 실행이 늦어질 수 있다.","advice":"핵심 결정을 정해두고 바로 행동하세요."},
    "2358":{"name":"생존 기획관","strengths":"체계적 판단과 전략 구상 능력이 탁월하다.","weaknesses":"독단적으로 보일 수 있으니 주의하자.","advice":"전략 공유로 팀의 신뢰와 속도를 높이세요."},
    "2457":{"name":"현장 실무자","strengths":"손재주와 즉시 해결 능력이 뛰어나다.","weaknesses":"장기 계획을 소홀히 할 위험이 있다.","advice":"즉흥력에 최소한의 계획을 더하세요."},
    "2467":{"name":"상황 조율자","strengths":"차분하고 조화롭게 협력한다.","weaknesses":"소극적 판단으로 기회를 놓칠 수 있다.","advice":"필요할 때는 명확하게 주도하세요."},
    "2367":{"name":"가치 탐색자","strengths":"창의적이고 의미 중심의 동기.","weaknesses":"현실적 제약에 취약할 수 있음.","advice":"창의적 아이디어를 실행 체크리스트로 구체화하세요."},
    "2357":{"name":"분석 중심가","strengths":"논리 분석과 대안 탐색이 빠르다.","weaknesses":"과분석으로 행동이 지연될 수 있다.","advice":"분석 마감시간을 정하고 실행하세요."},
    "1457":{"name":"신속 대응자","strengths":"위기에도 침착하고, 즉각적 행동에 능하다.","weaknesses":"무모함으로 리스크를 키울 수 있으니 주의하자.","advice":"행동 전 핵심 금지사항만 점검!"},
    "1467":{"name":"분위기 전환가","strengths":"적응력·사기 진작 능력이 우수하다.","weaknesses":"주의 산만·계획 부족의 가능성이 있다.","advice":"기본 안전수칙을 체크리스트로 고정하세요."},
    "1367":{"name":"에너지 추적가","strengths":"창의·동기 부여, 다양한 시도.","weaknesses":"우왕좌왕으로 에너지 소모가 심하다.","advice":"우선순위 3가지를 정하고 거기에 집중하세요."},
    "1357":{"name":"임기응변 전문가","strengths":"재치 있는 문제 해결과 기민한 판단이 주.","weaknesses":"규칙 무시·충동 위험이 있다.","advice":"도전하되 ‘금지·필수’ 규칙은 반드시 준수하세요."},
    "1458":{"name":"현장 지휘관","strengths":"조직·실행력이 탁월하며, 신속한 지휘가 가능하다.","weaknesses":"융통성이 부족하고 고집 위험이 있다.","advice":"대안 경로를 항상 1개 이상 준비하세요."},
    "1468":{"name":"공동체 중심","strengths":"협력·유대 강화에 강하다.","weaknesses":"자기 소모와 피로 누적이 심하다.","advice":"역할 분담과 휴식 스케줄을 명확히 하자."},
    "1368":{"name":"협력 리더","strengths":"이타적 리더십, 팀 결속 ↑.","weaknesses":"과책임·번아웃 위험이 있으니 주의하자.","advice":"책임을 위임하고 팀의 자율을 신뢰하세요."},
    "1358":{"name":"실행 책임가","strengths":"강한 결단과 실행 속도를 지녔다.","weaknesses":"독단·갈등 유발 위험이 있다.","advice":"핵심 결정 공유·피드백 루프를 운영하세요."}
}
