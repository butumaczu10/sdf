...
questions = [
    ...
    {"situation":"🌋 화산 폭발",
     ...
     "options":{"5":"먼저 가장 합리적인 탈출 경로를 계산한다",
...
# ----------------- 16유형 데이터 -----------------
TYPES = {
    "2458":{"name":"신중한 분석가형 생존자","strengths":"계획적·현실적, 위기에서도 침착.","weaknesses":"융통성 부족으로 돌발 변수에 약할 수 있음.","advice":"세운 계획을 기본으로 하되 예외 시나리오를 준비하세요."},
    "2468":{"name":"헌신적인 수호자형 생존자","strengths":"타인을 잘 돌보고 신뢰감을 줌.","weaknesses":"자기 안전을 뒤로 미루는 경향.","advice":"도움과 자기보호의 균형을 지키세요."},
    "2368":{"name":"통찰력 있는 조언자형 생존자","strengths":"상황을 넓게 읽고 장기 전략에 강함.","weaknesses":"과도한 고민으로 실행이 늦어질 수 있음.","advice":"핵심 결정을 정해두고 바로 행동하세요."},
    "2358":{"name":"전략적인 설계자형 생존자","strengths":"체계적 판단·전략 구상 능력 탁월.","weaknesses":"독단적으로 보일 수 있음.","advice":"전략 공유로 팀의 신뢰와 속도를 높이세요."},
    "2457":{"name":"실용적인 해결사형 생존자","strengths":"손재주·즉시 해결 능력 뛰어남.","weaknesses":"장기 계획을 소홀히 할 위험.","advice":"즉흥력에 최소한의 계획을 더하세요."},
    "2467":{"name":"온화한 적응가형 생존자","strengths":"차분하고 조화롭게 협력.","weaknesses":"소극적 판단으로 기회를 놓칠 수 있음.","advice":"필요할 때는 명확하게 주도하세요."},
    "2367":{"name":"이상적인 탐색자형 생존자","strengths":"창의적이고 의미 중심의 동기.","weaknesses":"현실적 제약에 취약할 수 있음.","advice":"창의적 아이디어를 실행 체크리스트로 구체화하세요."},
    "2357":{"name":"호기심 많은 사색가형 생존자","strengths":"논리 분석·대안 탐색이 빠름.","weaknesses":"과분석으로 행동이 지연될 수 있음.","advice":"분석 마감시간을 정하고 실행하세요."},
    "1457":{"name":"대담한 행동가형 생존자","strengths":"위기에도 침착, 즉각적 행동.","weaknesses":"무모함으로 리스크를 키울 수 있음.","advice":"행동 전 핵심 금지사항만 점검!"},
    "1467":{"name":"활기찬 즉흥가형 생존자","strengths":"적응력·사기 진작 능력 우수.","weaknesses":"주의 산만·계획 부족 가능.","advice":"기본 안전수칙을 체크리스트로 고정하세요."},
